...
M.parse_cargo_metadata = function(cargo_metadata)
...
M.cargo_inspector = function(config)
  ...
  vim.api.nvim_set_option_value("buftype", "nofile", { scope = "local", buf = compiler_msg_buf })
  ...
  local cargo_job = vim.fn.jobstart(cargo_cmd, {
    ...
    on_exit = function(_, exit_code)
      ...
      if vim.api.nvim_win_is_valid(compiler_msg_window) then vim.api.nvim_win_close(compiler_msg_window, true) end
